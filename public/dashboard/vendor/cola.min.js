            ...
            function i(a, b) {
              for (var c = void 0, d = 0; d < t.length; d++)
                if (
                  ...
                  t[d].x + t[d].width + a.width + f.PADDING - b <=
                    f.FLOAT_EPSILON
                ) {
                  c = t[d];
                  break;
              ...
              (t.push(a),
                void 0 !== c
                  ...
                  : ((a.y = s),
                    ...
                    (a.bottom = a.y),
                    (a.space_left = a.height)),
                a.y + a.height - q > -f.FLOAT_EPSILON &&
                  (q = a.y + a.height - m),
                a.x + a.width - p > -f.FLOAT_EPSILON &&
                  (p = a.x + a.width - l));
            }
            function j(a) {
              var b = 0;
                  ...
                  : ((v = new j.Calculator(
                    ...
                    this._links.forEach(function (a) {
                      ("number" == typeof a.source &&
                        (a.source = l._nodes[a.source]),
                        "number" == typeof a.target &&
                          (a.target = l._nodes[a.target]));
                    }),
          ...
          var A = (function () {
            function a(a, b, c, e, f) {
              ...
              if (
                ...
                var h = a.length;
                b.forEach(function (a) {
                  ((g.variables[h] = a.minVar =
                    new z(h++, void 0 !== a.stiffness ? a.stiffness : 0.01)),
                    (g.variables[h] = a.maxVar =
                      new z(h++, void 0 !== a.stiffness ? a.stiffness : 0.01)));
                });
              }
            }
