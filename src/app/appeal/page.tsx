...
export const metadata: Metadata = {
  title: "Ban Appeal | Dawn Winery",
  description: "Submit a ban appeal to rejoin Dawn Winery",
};
          ...
          {appealsConfig.open ? (
            <>
              <p className="animate-fade-in-up animate-delay-3 mb-6 text-sm leading-relaxed text-[var(--discord-muted)]">
                If you were banned from the server, you can submit an appeal
                here. Be honest and explain why you should be allowed back.
              </p>
              <AppealForm
            ...
            <p className="animate-fade-in-up animate-delay-3 text-sm leading-relaxed text-[var(--discord-muted)]">
              Ban appeals are currently closed. Check back later for updates.
            </p>
          )}
        </div>
      </div>
